$(document).ready(function () {
    ...
    $("#screen_slider").owlCarousel({
        ...
        var o = e.item.index;
        $(".screenshots .screenshot").removeClass("active"), $(".screenshots .screenshot[data-screen=" + o + "]").addClass("active")
        ...
        $("#videoModal .embed_video").html('<iframe width="100%" height="450px" src="https://www.youtube.com/embed/' + o + '?autoplay=true&rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>'), setTimeout(t, 1e3)
